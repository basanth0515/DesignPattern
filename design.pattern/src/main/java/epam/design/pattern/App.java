package epam.design.pattern;
import java.io.*;
import java.awt.*;
import java.util.*;
import epam.design.pattern.Builder;
import epam.design.pattern.Singleton;
import epam.design.pattern.BasicRemote;
import epam.design.pattern.Device;
import epam.design.pattern.Forest;
import epam.design.pattern.Radio;
import epam.design.pattern.Tv;
import epam.design.pattern.Button;
import epam.design.pattern.Command;
import epam.design.pattern.DomesticEngineer;
import epam.design.pattern.Politician;
import epam.design.pattern.Programmer;
public class App 
{
